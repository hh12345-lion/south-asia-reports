  ...
  return (
    <>
      ...
      <PageShell title="Cookie Policy" subtitle="Last updated: June 2026" breadcrumbs={crumbs}>
        ...
        <h2 className="mt-10 text-xl font-bold text-[#1B2A4A]">What are cookies?</h2>
        ...
        <h2 className="mt-10 text-xl font-bold text-[#1B2A4A]">Google Consent Mode</h2>
        <p className="mt-4 text-[#374151] leading-relaxed">
        ...
        <h2 className="mt-10 text-xl font-bold text-[#1B2A4A]">Cookie categories</h2>
        <div className="mt-4 space-y-4">
          {(Object.keys(CATEGORY_META) as Array<keyof typeof CATEGORY_META>).map((key) => {
            const meta = CATEGORY_META[key];
            return (
              <section key={key} className="rounded-[8px] border border-[#D1DCE6] bg-[#F0F4F8] p-4">
                <h3 className="font-semibold text-[#1B2A4A]">{meta.label}</h3>
        ...
        <h2 className="mt-10 text-xl font-bold text-[#1B2A4A]">Third-party services</h2>
        <p className="mt-4 text-[#374151] leading-relaxed">
        ...
        <h2 className="mt-10 text-xl font-bold text-[#1B2A4A]">Your choices</h2>
        <p className="mt-4 text-[#374151] leading-relaxed">
        ...
        <h2 className="mt-10 text-xl font-bold text-[#1B2A4A]">California residents (CCPA)</h2>
        <p className="mt-4 text-[#374151] leading-relaxed">
        ...
        <h2 className="mt-10 text-xl font-bold text-[#1B2A4A]">Browser controls</h2>
        <p className="mt-4 text-[#374151] leading-relaxed">
        ...
        <h2 className="mt-10 text-xl font-bold text-[#1B2A4A]">Contact</h2>
        <p className="mt-4 text-[#374151] leading-relaxed">
