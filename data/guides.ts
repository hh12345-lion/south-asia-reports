...
export const guides: Guide[] = [
  {
    ...
    content: [
      "The August 2024 fall of Sheikh Hasina's Awami League government has fundamentally changed the landscape for Bangladesh asylum claims in tribunals. This guide explains the political transition, its impact on existing and new claims, and how expert evidence should address post-transition conditions.",
  ...
  },
  {
    ...
    metaDescription:
      "Guide to India asylum claims in tribunals. Hindutva, CAA/NRC, Sikhs, internal relocation, state protection analysis, and expert evidence methodology.",
    h1: "India Asylum Claims: Expert Evidence Guide for UK Solicitors",
    content: [
      "India generates growing asylum claim volumes, driven by Hindutva targeting of Muslims, Sikh claims, Christian minority persecution, caste discrimination, and political dissident persecution. This guide explains how expert evidence addresses the key legal challenges in India asylum claims.",
      "The decision-makers frequently argues that internal relocation within India is available, particularly to major cities. Expert witnesses challenge this where Hindutva networks and RSS have national reach, where the appellant's profile is identifiable nationwide, or where relocation would be unduly harsh.",
  ...
  },
  {
    ...
    content: [
      "KK and Others (Sri Lanka: Tamil) CG [2021] UKUT 00245 is the binding country guidance for Sri Lanka Tamil asylum claims in tribunals. This guide explains the KK framework, the risk profiles it identifies, and how expert evidence supports Tamil persecution claims.",
  ...
  },
  {
    ...
    metaDescription:
      "Guide to current South Asia CPINs for counsel. CPIN coverage gaps, expert evidence filling gaps, Bangladesh post-2024, India, Sri Lanka, Nepal, Bhutan.",
    h1: "South Asia CPINs 2025: A Solicitor's Guide",
    content: [
      "decision-makers Country Policy and Information Notes (CPINs) provide the starting point for country conditions analysis in asylum proceedings. This guide maps current CPIN coverage for South Asian countries and identifies where expert evidence is needed to fill gaps.",
  ...
  },
  {
    ...
    metaDescription:
      "Guide to Nepal and Bhutan asylum claims. No country guidance, Maoist claims, Dalits, Lhotshampa, why expert evidence is essential for tribunal proceedings.",
    h1: "Nepal and Bhutan Asylum Claims: Expert Evidence Guide",
    content: [
      "Nepal and Bhutan present unique challenges for asylum practitioners because neither country has current UK Upper Tribunal country guidance. Without binding country guidance, tribunals must rely on the quality and independence of expert evidence to assess country conditions and individual risk.",
    ...
    faqs: [
      {
        question: "Why is there no country guidance for Nepal?",
        answer:
  ...
  },
  {
    ...
    metaDescription:
      "Guide to instructing South Asia country experts for tribunals. Language experts, field research, letter of instruction, Legal Aid, tribunal requirements.",
    h1: "Instructing a South Asia Country Expert: A Solicitor's Guide",
    content: [
      "This guide explains the instruction process for South Asia country expert witnesses in asylum and immigration proceedings, covering expert selection, letter of instruction, Legal Aid requirements, and tribunal compliance.",
